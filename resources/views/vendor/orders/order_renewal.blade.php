        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">View Service Renewal Order</h2>
                    <div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/dashboard')}}"><i class="ti ti-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">View All Renewal Orders</a></li>
                                ...
                                @if(isset($renewals) and sizeof($renewals)>0)
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="custom_card">
                                            ...
                                            <p><strong>Customer: </strong> {{$p->order_item->customer->first_name}} {{$p->order_item->customer->last_name}} ({$p->order_item->customer->ref_no}})</p>
                                            <p><strong>Price: </strong>{{$p->price}} PKR</p>
                                            <p><strong>Status: </strong>{{$p->status}}</p>
                                            <p><strong>Date: </strong>{{date('M-d-Y',strtotime($p->created_at))}}</p>
                                            <td class="td-actions">
                                                <a  href="{{route('send_email_to_customer',[$p->order_item->customer->id])}}">Send Email To Customer</a>
                                            </td>
                                        </div>
                                    </div>
                                    @endforeach
                                ...
                                <div class="table-responsive">
                                    <table id="" class="export-table table table-bordered mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$p->order_item->customer->first_name}} {{$p->order_item->customer->last_name}} ({{$p->order_item->customer->ref_no}})</td>
                                            <td>{{$p->price}} PKR</td>
                                            <td>{{$p->status}}</td>
