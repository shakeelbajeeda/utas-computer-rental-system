...
<form id="i_form" novalidate="" action="{{route('save_identity')}}" method="post" enctype='multipart/form-data'>
...
<input name="first_name" type="text" class="form-control custom_required" value="{{$user->first_name}}">
</div>

<div class="col-lg-6">
<label>Last Name</label>
<input name="last_name" type="text" class="form-control custom_required" value="{{$user->last_name}}">
</div>
</div>
<div class="form-group row d-flex align-items-center">
...
<input name="phone" type="text" class="form-control custom_required" value="{{$user->phone}}">
</div>
</div>
<div class="form-group row d-flex align-items-center">
...
<div class="col-lg-6">
<label>City</label>
<input name="city" type="text" class="form-control custom_required" value="{{$user->city}}">
</div>

<div class="col-lg-6">
<label>Address</label>
<input name="address" type="text" class="form-control custom_required" value="{{$user->address}}">
</div>
<div class="col-lg-6">
    <br>
...
<div class="col-lg-3">
    ...
    <div class="input-group">
        ...
        <div class="avatar-upload">
            ...
            <div class="avatar-edit">
                <input type="file" img="11" class="form-control @if(!isset($user->front_passport_img)) custom_required @endif" onchange="changeAvatar(this)" name="front_passport_img" id="imageUpload11" accept=".png, .jpg, .jpeg">
                <label for="imageUpload11"></label>
            </div>
            <div class="avatar-preview">
                @if(isset($user->front_passport_img))
                    <div id="imagePreview11">
                        <img id="imageEditPreview11" style="height: 69px;width: 69px;border-radius: 100%;" src="{{asset('/public/images/doc_images')}}/{{ $user->front_passport_img}}">
                    </div>
                    @else
                <div id="imagePreview11" style="background-image: url({{asset('assets/img/default.png')}});">
...
<div class="col-lg-3">
    ...
    <div class="input-group">
        ...
        <div class="avatar-upload">
            ...
            <div class="avatar-edit">
                <input type="file" img="1111" class="form-control @if(!isset($user->front_cnic_img)) custom_required @endif" onchange="clientavatar(this)" name="front_cnic_img" id="imageUpload1111" accept=".png, .jpg, .jpeg">
                <label for="imageUpload1111"></label>
            </div>
            <div class="avatar-preview">
                @if(isset($user->front_cnic_img))
                    <div id="imagePreview1111">
                        <img id="imageEditPreview1111" style="height: 69px;width: 69px;border-radius: 100%;" src="{{asset('/public/images/doc_images')}}/{{ $user->front_cnic_img}}">
                    </div>
                    @else
                <div id="imagePreview1111" style="background-image: url({{asset('assets/img/default.png')}});">
...
<div class="col-lg-3">
    ...
    <div class="input-group">
        ...
        <div class="avatar-upload">
            ...
            <div class="avatar-edit">
                <input type="file" img="11111" class="form-control @if(!isset($user->back_cnic_img)) custom_required @endif" onchange="clientavatar(this)" name="back_cnic_img" id="imageUpload11111" accept=".png, .jpg, .jpeg">
                <label for="imageUpload11111"></label>
            </div>
            <div class="avatar-preview">
                @if(isset($user->back_cnic_img))
                    <div id="imagePreview11111">
                        <img id="imageEditPreview11111" style="height: 69px;width: 69px;border-radius: 100%;" src="{{asset('/public/images/doc_images')}}/{{ $user->back_cnic_img}}">
                    </div>
                    @else
                <div id="imagePreview11111" style="background-image: url({{asset('assets/img/default.png')}});">
...
<button class="btn btn-gradient-01" type="button" onclick="form_validation('.custom_required');">Save Changes</button>
