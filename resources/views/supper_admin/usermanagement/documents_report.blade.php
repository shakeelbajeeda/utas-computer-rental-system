        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Document Report</h2>
                    <div>
                        <ul class="breadcrumb">
            ...
            <div class="col-xl-12">
                ...
                <div class="widget has-shadow">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="needs-validation" novalidate=""   action="{{route('save_document')}}" autocomplete="off" method="post" role="form" enctype="multipart/form-data">
                            @csrf
