                ...
                <div class="widget has-shadow">
                    <div class="widget-header bordered no-actions d-flex align-items-center">
                        <ul class="nav nav-pills">
                            ...
                            <li>
                                <a href="#under_review" data-toggle="tab">
                                    <button type="button" class="btn btn-outline-danger mr-1 mb-2 remove_active" onclick="add_class_active(this);">Profiles Under Review ({{count($under_review_users)}})</button>
                                </a>
                            </li>
                            <li>
                            ...
                            <div class="tab-pane active" id="rental_properties">
                                <div class="table-responsive">
                                    <table id="" class="export-table table table-bordered mb-0">
                                        ...
                                        <tr>
                                            <td><?=$p->first_name?> <?=$p->last_name?> ({{$p->ref_no}})</td>
