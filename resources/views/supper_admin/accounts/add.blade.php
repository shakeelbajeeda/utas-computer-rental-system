        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Recharge an Account</h2>
                    <div>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Recharge an Account
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-xl-12">
                <div class="widget has-shadow">
                    <div class="widget-header bordered no-actions d-flex align-items-center">
                        <h4>Recharge an Account
                        </h4>
                    </div>
                    <div class="widget-body">

                                    <form id="i_form" action="{{route('recharges.store')}}" method="post"
                                        ...
                                        <div class="form-group row d-flex align-items-center">
                                            ...
                                            <select name="user" class=" form-control selectpicker show-menu-arrow"  data-live-search="true">

                                            <?php if(isset($users) and sizeof($users)>0):?>
                                            <?php foreach($users as $c):?>
                                                    <option value="<?=$c->id?>"><?=$c->name?> | {{$c->email}} | {{$c->phone}} Existing Balance: ${{$c->total_money}}</option>
                                            <?php endforeach;
                                            else: ?>
                                        ...
                                        <div class="text-right">
                                            <button class="btn btn-gradient-01" type="submit">Add Amount</button>
