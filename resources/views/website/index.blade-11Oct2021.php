...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{asset('public/angvo/assets/images/slider_images/slider_1.jpg')}}" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{{asset('public/angvo/assets/images/slider_images/slider_2.jpg')}}" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{{asset('public/angvo/assets/images/slider_images/slider_3.jpg')}}" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{{asset('public/angvo/assets/images/slider_images/slider_4.jpg')}}" alt="4th slide">
    </div>
  </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-thumb text-center">
                    <img src="{{asset('public/angvo/assets/images/about-thumb.jpg')}}" alt="">
                </div>
            </div>
            <div class="col-lg-6">
...
<!-- <section class="team-area pt-130 pb-130" style="border-bottom: 1px solid #101e3ba3;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5">
            ...
            <div class="col-lg-7">
                <div class="row team-active">
                    <div class="col-lg-6">
                        <div class="team-item">
                            <img src="{{asset('public/angvo/assets/images/team-1.jpg')}}" alt="team">
                    ...
                    <div class="col-lg-6">
                        <div class="team-item">
                            <img src="{{asset('public/angvo/assets/images/team-2.jpg')}}" alt="team">
                            <div class="team-overlay">
                                <div class="team-contet text-center">
                                    <ul>
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-7">
                <div class="working-item text-center item-1">
                    <i class="fal fa-head-side-brain">
                       <img src="{{asset('public/angvo/assets/images/icons/icon_1.png')}}">
                    </i>
            ...
            <div class="col-lg-3 col-md-6 col-sm-7">
                <div class="working-item text-center item-2">
                    <i class="fal fa-layer-group">
                        <img src="{{asset('public/angvo/assets/images/icons/icon_2.png')}}">
                    </i>
