                ...
                <div class="main_div">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <br>
                            <label class="ChooseSubscription">Choose Subscription</label>
            ...
            <div class="col-md-8">
                <div class="main_div">
                    <div class="row">
                        ...
                        <div class="col-lg-8" data-2x="here">
                            @if(isset($service->always_price) and $service->always_price >0)
                            ...
                            @endif
                            @if(isset($service->always_price) and $service->always_price >0)
                            <button id="always_pkg" style="display:none;" type="button" class="btn btn-primary all_btns btn_unactive" package="Always" discount="{{$service->always_discount}}" price="{{$service->always_discounted_price}}" vendor_price="{{$service->always_vendor_price}}" actual_price="{{$service->always_price}}" onclick="apply_pkg(this);"> Always </button>
                            @endif
                            <br>
...
@section('footer_scripts')
 <script>
     ...
     @elseif(isset($service->six_month_price) and $service->six_month_price >0)
      ...
      @elseif(isset($service->always_price) and $service->always_price >0)
        $('#always_pkg').click();
     ...
     @if($service->is_sub_service==1)
         ...
         @elseif(isset($service->sub_services->first()->always_price) and $service->sub_services->first()->always_price >0)
            $('#always_pkg').click();
     ...
     function apply_sub_service() {
        ...
        if(sub.always_price && sub.always_price >0) {

            $(".ChooseSubscription").hide();
            append_able += '<button style="display:none;" id="always_pkg" type="button" class="btn btn-primary all_btns btn_unactive" package="Always" discount="'+sub.always_discount+'" sub_service_id="'+sub.id+'" sub_service_title="'+sub.title+'" price="'+sub.always_discounted_price+'" vendor_price="'+sub.always_vendor_price+'"  actual_price="'+sub.always_price+'" onclick="apply_pkg(this);"> Always </button>'
