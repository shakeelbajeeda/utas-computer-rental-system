                            ...
                            @if(!auth()->check())
                                <!-- login form starts here -->
                                    <div class="col-md-12">
                                        ...
                                        <form role="form"action="javascript:void(0);" method="post" class="require-validation"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 PaymentDetailsDiv" style="display:none;">
                                                <br />
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <button class="btn btn-dark rounded-pill py-2 btn-block custom_btn"
                                                        type="button" onclick="do_checkout(this);">Confirm Order
                                                </button>

                                                <button class="btn btn-dark rounded-pill py-2 btn-block  stripe_btn" style="display:none;"
...
@section('footer_scripts')
    ...
    <script>
        ...
        $(document).on("click",".stripe_btn",function (e) {
            ...
            if ($('#card_holder_number').val() != '' && $('#card_expiry_month').val() != '' && $('#card_cvc').val()) {
                $('#card-errors').hide();
