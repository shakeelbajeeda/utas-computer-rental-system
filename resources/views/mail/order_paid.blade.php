	...
	<p>
		...
		<span>Subtotal:</span> {{$order->subtotal}}  PKR<br>
		<span>Discount:</span> {{$order->coupon_discount}} PKR<br>
		<span>Total Payable Amount:</span> {{$order->total}}  PKR<br>
		<span>Payment Method:</span> {{$order->payment_method}} <br>
		<span>Status:</span> {{$order->status}} <br>

	</p>
	<p>
		You had bought following services
	</p>
	...
	<tbody>
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px">
				{{number_format((float)$order->subtotal, 2, '.', '')}} PKR
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px">
				{{number_format((float)$order->coupon_discount, 2, '.', '')}} PKR
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px">
				{{number_format((float)$order->total, 2, '.', '')}} PKR
